...
import { Header as RNHeader, NavigationScreenProps, StackNavigatorConfig, HeaderProps } from 'react-navigation';
...
export const Header = connect((state: any, props: HeaderProps): any => ({
  getScreenDetails: (scene) => {
    ...
    const border = Platform.OS === 'android' && Platform.Version >= 21
      ? { borderTopWidth: 20, borderTopColor: getColor(state), height: 56 + 20 }
      : {}
...
export const headerNavigationOptions: any = {
  ...
  navigationOptions: ({ navigation }) => ({
    header: function (props) { return <Header { ...props} />},
    headerTintColor: '#fff',
