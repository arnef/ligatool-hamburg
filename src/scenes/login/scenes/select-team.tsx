...
import { Content, Separator, ListItem, TeamLogo, Text } from '../../../components';
...
function mapDispatchToProps(dispatch: Dispatch<any>): DispatchProps {
  return {
    setUserTeam: (team: any) => dispatch({ type: 'SELECT_USER_TEAM', payload: { id: team.id }}),
  }
}

export const SelectTeam = connect(mapStateToProps, mapDispatchToProps)(SelectTeamScene);