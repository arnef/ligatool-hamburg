...
class ScoreInput extends Component {
    ...
    render() {
        const playerHome1 = this.props.data.sets ? this.props.data.sets[0].player_1_home : {}
        const playerAway1 = this.props.data.sets ? this.props.data.sets[0].player_1_away : {}
        const playerHome2 = this.props.data.sets ? this.props.data.sets[0].player_2_home : null
        const playerAway2 = this.props.data.sets ? this.props.data.sets[0].player_2_away : null
